...
func TestDeposits(t *testing.T) {
	...
	fourSteak := sdk.Coins{sdk.Coin{"steak-atto", toBigInt(4)}}
	fiveSteak := sdk.Coins{sdk.Coin{"steak-atto", toBigInt(5)}}
	...
	require.Equal(t, sdk.Coins{sdk.Coin{"steak-atto", toBigInt(42)}}, addr0Initial)
