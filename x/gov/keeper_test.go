...
func TestDeposits(t *testing.T) {
	...
	fourSteak := sdk.Coins{sdk.Coin{"steak_iota", toBigInt(4)}}
	fiveSteak := sdk.Coins{sdk.Coin{"steak_iota", toBigInt(5)}}
	...
	require.Equal(t, sdk.Coins{sdk.Coin{"steak_iota", toBigInt(42)}}, addr0Initial)
