...
func (k Keeper) CleanupPacket(
	...
	if !found {
		return nil, types.ErrChannelNotFound(k.codespace, packet.GetSourceChannel())
	}
...
func (k Keeper) SendPacket(
	...
	channel, found := k.GetChannel(ctx, packet.GetSourcePort(), packet.GetSourceChannel())
	if !found {
		return types.ErrChannelNotFound(k.codespace, packet.GetSourceChannel())
	}
...
func (k Keeper) RecvPacket(
	...
	if !found {
		return nil, types.ErrChannelNotFound(k.codespace, packet.GetDestChannel())
	}
