...
func TestCheckTx(t *testing.T) {
	...
	routerOpt := func(bapp *BaseApp) {
		...
		bapp.Router().AddRoute(typeMsgCounter, []*sdk.KVStoreKey{capKey1}, func(ctx sdk.Context, msg sdk.Msg) sdk.Result { return sdk.Result{} })
	}
...
func TestDeliverTx(t *testing.T) {
	...
	routerOpt := func(bapp *BaseApp) { bapp.Router().AddRoute(typeMsgCounter,[]*sdk.KVStoreKey{capKey1}, handlerMsgCounter(t, capKey1, deliverKey)) }
...
func TestMultiMsgDeliverTx(t *testing.T) {
	...
	routerOpt := func(bapp *BaseApp) {
		bapp.Router().AddRoute(typeMsgCounter, []*sdk.KVStoreKey{capKey1} ,handlerMsgCounter(t, capKey1, deliverKey))
		bapp.Router().AddRoute(typeMsgCounter2, []*sdk.KVStoreKey{capKey2} ,handlerMsgCounter(t, capKey1, deliverKey2))
	}
...
func TestSimulateTx(t *testing.T) {
	...
	routerOpt := func(bapp *BaseApp) {
		bapp.Router().AddRoute(typeMsgCounter,[]*sdk.KVStoreKey{capKey1}, func(ctx sdk.Context, msg sdk.Msg) sdk.Result {
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	routerOpt := func(bapp *BaseApp) {
		bapp.Router().AddRoute(typeMsgCounter,[]*sdk.KVStoreKey{capKey1}, func(ctx sdk.Context, msg sdk.Msg) (res sdk.Result) { return })
	}
